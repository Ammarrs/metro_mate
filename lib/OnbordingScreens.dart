            ...
            body: PageView(
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(color: Color(0xff6D94BB)),
                  child: Center(
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          Padding(
                            ...
                            child: TextButton(
                              ...
                              child: Text(
                                S.current.Skip,
                                style: TextStyle(
                                    color: Color(0xff6B7688), fontSize: 20),
                              ),
                            ),
                          ),
                          SizedBox(
                          ...
                          Text(S.current.OnboardingTitle1,
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(S.current.OnboardingTitle2,
                              style: TextStyle(fontSize: 32)),
                          SizedBox(
                            height: 20,
                          ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(S.current.OnboardingTitle3,
                              style: TextStyle(fontSize: 32)),
                          SizedBox(
                            height: 20,
                          ),
