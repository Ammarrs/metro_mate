                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(fontSize: 18, color: Color(0xffE2EBF0)),
                    )
                  ],
                ),
              ),
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Icon(Icons.qr_code_2,
                                            size: 80, color: Color(0xff5A72A0)),
                                        SizedBox(height: 20),
                                        Text(
                                          "Ticket QR Code",
                                          style: TextStyle(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      "1. Show this QR code at the metro station gate",
                                    ...
                                    Text(
                                      "2. Place your phone over the scanner",
                                      style: TextStyle(color: Colors.grey),
                                    ),
                                    SizedBox(
                                      height: 10,
                                    ...
                                    Text(
                                      "3. Wait for the green light and gate to open",
                                      style: TextStyle(color: Colors.grey),
                                    ),
                                    SizedBox(
                                      height: 10,
                                    ...
                                    Text(
                                      "4. Each ticket is valid for 24 hours from purchase",
                                      style: TextStyle(color: Colors.grey),
                                    ),
                                  ],
                                ),
