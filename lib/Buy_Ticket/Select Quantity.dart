                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Center(
                                      child: Text(
                                    "${S.of(context).EGP} ${cubit.price} ${S.of(context).each}",
                                    style: TextStyle(
                                        fontSize: 12,
                                        fontWeight: FontWeight.bold,
                                        color: Colors.white),
                              ...
                              children: [
                                MaterialButton(
                                  ...
                                  child: Text(
                                    "-",
                                    style: TextStyle(
                                        color: Color(0xff5A72A0), fontSize: 40),
                                  ),
                                ),
                                Container(
                                  width: 80,
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Expanded(
                                            child: Text(
                                              "${cubit.time} ${S.of(context).minutes} • ${cubit.distance} ${S.of(context).KM}",
                                              style: TextStyle(
                                                  color: Colors.grey,
                                                  fontSize: 15),
                                              overflow: TextOverflow.ellipsis,
