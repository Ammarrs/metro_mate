                ...
                children: [
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        Text('Language',
                            style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: Color(0xFF1A2E3D))),
                        SizedBox(height: 2),
                        Text('Choose your preferred language',
                            style: TextStyle(fontSize: 12, color: Color(0xFF8FA8BE))),
                      ],
                    ),
                  ),
                  _LanguageToggle(selected: state.language, onChanged: cubit.toggleLanguage),
                ],
              ),
            ),
...
class _LanguageToggle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        _LangOption(label: 'English', isSelected: selected == AppLanguage.english,
            onTap: () => onChanged(AppLanguage.english)),
        const SizedBox(width: 12),
        _LangOption(label: 'العربية', isSelected: selected == AppLanguage.arabic,
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: isSelected ? kPrimaryBlue : const Color(0xFFCDD8E3), width: 2),
            ),
          ),
          ...
          Text(label,
              style: TextStyle(
                ...
                color: isSelected ? kPrimaryBlue : const Color(0xFF8FA8BE),
              )),
        ],
      ),
    );
